...
module.exports = {
    name: "fox", // Nome principal do comando
    description: "Comando para mostrar imagens de raposas.", // Descrição do comando
    aliases: ["raposas"], // Apelidos do comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix) {
        let data = await fetch(`https://randomfox.ca/floof/`).then(rep => rep.json()); // Faz a busca da api e envia em json
