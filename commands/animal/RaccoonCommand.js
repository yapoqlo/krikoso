...
module.exports = {
    name: "raccoon", // Nome principal do comando
    description: "Comando para mostrar imagens de guaxinins.", // Descrição do comando
    aliases: ["guaxinins"], // Apelidos do comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix) {
        let data = await fetch(`https://some-random-api.ml/img/racoon`).then(rep => rep.json()); // Faz a busca da api e envia em json
