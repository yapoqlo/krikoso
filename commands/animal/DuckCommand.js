...
module.exports = {
    name: "duck", // Nome principal do comando
    description: "Comando para mostrar imagens de patos.", // Descrição do comando
    aliases: ["patos"], // Apelidos do comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix) {
        let data = await fetch(`https://random-d.uk/api/v1/random?type=gif`).then(rep => rep.json()); // Faz a busca da api e envia em json
