...
module.exports = {
    name: "bird", // Nome principal do comando
    description: "Comando para mostrar imagens de passaros.", // Descrição do comando
    aliases: ["passaros"], // Apelidos do comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix) {
        let data = await fetch(`https://some-random-api.ml/img/birb`).then(rep => rep.json()); // Faz a busca da api e envia em json
