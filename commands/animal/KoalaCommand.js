...
module.exports = {
    name: "koala", // Nome principal do comando
    description: "Comando para mostrar imagens de koalas.", // Descrição do comando
    aliases: ["coalas"], // Apelidos do comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix) {
        let data = await fetch(`https://some-random-api.ml/img/koala`).then(rep => rep.json()); // Faz a busca da api e envia em json
