...
module.exports = {
    name: "dog", // Nome principal do comando
    description: "Comando para mostrar imagens de cachorros.", // Descrição do comando
    aliases: ["cachorros"], // Apelidos do comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix) {
        let data = await fetch(`https://random.dog/woof.json`).then(rep => rep.json()); // Faz a busca da api e envia em json
