...
module.exports = {
    name: "iphonex", // Nome principal do comando
    description: "Comando para mostrar um celular com o fundo a sua escolha.", // Descrição do comando
    aliases: ["celular"], // Apelidos do comando
    ...
    usage: "[Mande  uma Imagem]", // Modo de uso para usar o comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix){
        ...
        fetch(`https://nekobot.xyz/api/imagegen?type=iphonex&url=${avatar_user}`)
            .then(res => res.json())
            .then(data => message.channel.send(`${message.author}`, new Discord.MessageAttachment(data.message, 'iphonex.png'))); // Faz a requisição na api do comando usando o nodefetch
