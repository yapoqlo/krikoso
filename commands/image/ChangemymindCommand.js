...
module.exports = {
    name: "changemymind", // Nome principal do comando
    description: "Comando para imagem de Me convença com a frase a sua escolha.", // Descrição do comando
    aliases: ["meconvenca"], // Apelidos do comando
    ...
    async execute(client, message, args, emojis, colors, config, prefix) {
        ...
        if (!text) {
            return message.channel.send(`${emojis.IconCross} **|** ${message.author}, você precisa escrever o **Conteúdo** para a placa do me convença.`); // Notifica o autor sobre a falta de argumentos
